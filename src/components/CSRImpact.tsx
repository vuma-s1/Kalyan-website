    ...
    <section id="csr-impact" className="py-8 lg:py-24 relative overflow-hidden" style={{ 
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-4 lg:mb-16">
                      <h2 className="text-2xl lg:text-5xl font-bold mb-2 lg:mb-8 drop-shadow-lg" style={{ fontFamily: 'Didot HTF L24 Light', letterSpacing: '0.05em', fontWeight: '700', color: '#9b3534' }}>
            <span className="block mb-2" style={{ color: '#9b3534' }}>Creating Lasting Change Through</span>
            <span className="block" style={{ color: '#9b3534' }}>Kalamandir Foundation</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {impactStats.map((stat, index) => {
            ...
            return (
              <div 
                key={index}
                className="group backdrop-blur-sm rounded-2xl shadow-lg border border-yellow-200 p-3 lg:p-6 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden"
                style={{ backgroundColor: '#ce6f69', animationDelay: `${index * 0.2}s` }}
              >
                {/* Icon */}
                <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-2xl flex items-center justify-center mb-2 lg:mb-4 mx-auto group-hover:scale-110 transition-all duration-500 shadow-lg" style={{ backgroundColor: 'rgba(155, 53, 52, 0.85)' }}>
                  <IconComponent className="w-6 h-6 lg:w-8 lg:h-8" style={{ color: '#ffe5d4' }} />
                </div>
                
                {/* Number */}
                <div className="text-center mb-1 lg:mb-3">
                  <div className="text-xl lg:text-4xl font-bold mb-0 lg:mb-1" style={{ fontFamily: 'FocusGrotesk, sans-serif', color: '#ffe5d4' }}>
                    {stat.number}
                  </div>
                  <div className="text-sm lg:text-lg font-semibold mb-1 lg:mb-2" style={{ fontFamily: 'FocusGrotesk, sans-serif', color: '#ffe5d4' }}>
                    {stat.label}
                  </div>
                </div>
                
                {/* Description */}
                <p className="text-center leading-relaxed" style={{ fontFamily: 'FocusGrotesk, sans-serif', fontWeight: 'normal', color: '#ffe5d4' }}>
                  {stat.description}
                </p>
        ...
        <div className="mt-6 lg:mt-12 text-center">
          <div className="backdrop-blur-sm rounded-2xl p-3 lg:p-6 border border-yellow-200 shadow-lg max-w-4xl mx-auto" style={{ backgroundColor: '#ce6f69' }}>
                          <div className="w-10 h-10 lg:w-14 lg:h-14 rounded-2xl flex items-center justify-center mx-auto mb-2 lg:mb-4" style={{ backgroundColor: 'rgba(155, 53, 52, 0.85)' }}>
                              <BiTrendingUp className="w-5 h-5 lg:w-7 lg:h-7" style={{ color: '#ffe5d4' }} />
            </div>
            <h3 className="text-base lg:text-xl font-bold mb-1 lg:mb-3" style={{ fontFamily: 'FocusGrotesk, sans-serif', color: '#ffe5d4' }}>
