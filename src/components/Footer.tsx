...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden footer-background">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="py-8 lg:py-12">
          ...
          <div className="text-center mb-8 lg:mb-12">
            ...
            <p className="text-gray-300 mb-4 max-w-2xl mx-auto text-sm lg:text-base">
              For collaborations, speaking engagements, or professional discussions about retail leadership and strategic growth.
            </p>
            <button
              onClick={scrollToContact}
              className="inline-flex items-center space-x-2 px-6 py-3 lg:px-8 lg:py-4 bg-yellow-500 text-gray-900 hover:bg-yellow-400 transition-all duration-300 font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-sm lg:text-base"
            >
        ...
        <div className="py-4 lg:py-6 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-xs lg:text-sm mb-3 md:mb-0 text-center md:text-left">
