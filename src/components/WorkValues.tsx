...
const WorkValues = () => {
  ...
  return (
    <section id="work-values" className="py-24 relative overflow-hidden" style={{ backgroundColor: '#fbe9b7' }}>
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-800 mb-4 drop-shadow-sm" style={{ fontFamily: 'NautilusPompilius, serif' }}>
