      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-yellow-200 hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#1E2531' }}>
                <BiHeart className="w-6 h-6 text-white" />
              </div>
              <h4 className="text-lg font-bold text-gray-800 mb-2" style={{ fontFamily: 'FocusGrotesk, sans-serif' }}>CSR Activities</h4>
              <p className="text-gray-700 text-sm" style={{ fontFamily: 'FocusGrotesk, sans-serif', fontWeight: 'normal' }}>Community development and social impact initiatives</p>
            </div>
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-yellow-200 hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#1E2531' }}>
                <BiBriefcase className="w-6 h-6 text-white" />
              </div>
              <h4 className="text-lg font-bold text-gray-800 mb-2" style={{ fontFamily: 'FocusGrotesk, sans-serif' }}>Board Meetings</h4>
              <p className="text-gray-700 text-sm" style={{ fontFamily: 'FocusGrotesk, sans-serif', fontWeight: 'normal' }}>Strategic leadership and governance</p>
            </div>
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-yellow-200 hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#1E2531' }}>
                <BiAward className="w-6 h-6 text-white" />
              </div>
              <h4 className="text-lg font-bold text-gray-800 mb-2" style={{ fontFamily: 'FocusGrotesk, sans-serif' }}>Cultural Events</h4>
              <p className="text-gray-700 text-sm" style={{ fontFamily: 'FocusGrotesk, sans-serif', fontWeight: 'normal' }}>Preserving and promoting cultural heritage</p>
            </div>
          </div>
        </div>
      </div>
